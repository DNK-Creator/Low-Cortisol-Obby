...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vLadderAction : vActionListener
    {
        ...
        private void Update()
        {
            if (isUsingLadder && !_isJumpLocked)
            {
                tpInput.LockJump(true);
                _isJumpLocked = true;
            }
            if(!isUsingLadder && _isJumpLocked)
            {
                tpInput.LockJump(false);
                _isJumpLocked = false;
            }
        }
        ...
        protected virtual void UsingLadder()
        {
            ...
            // go up or down 
            speed = tpInput.moveJoystick.Vertical;
